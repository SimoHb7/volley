...
import com.example.test_1.adapter.EtudiantAdapter;
import com.example.test_1.classes.Etudiant;
...
public class ListEtudiantsActivity extends AppCompatActivity implements EtudiantAdapter.OnItemClickListener {
    ...
    // Update these URLs
    private String fetchUrl = "http://192.168.1.9/projet/ws/loadEtudiant.php";
    private String updateUrl = "http://192.168.1.9/projet/ws/updateEtudiant.php";
    private String deleteUrl = "http://192.168.1.9/projet/ws/deleteEtudiant.php";
